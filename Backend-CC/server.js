...
app.post("/q", (req, res) => {
  ...
  pool.query(
    "INSERT INTO questions_table (Context, original_question, modified_question) VALUES ?",
    [values],
    (err, results) => {
      if (err) {
...
app.get("/question/:context", (req, res) => {
  ...
  pool.query(
    "SELECT * FROM questions_table WHERE Context = ?",
    [context],
    (err, results) => {
      if (err) {
...
app.put("/question/:context", (req, res) => {
  ...
  pool.query(
    "UPDATE questions_table SET Question = ? WHERE Context = ?",
    [updatedQuestion, context],
    (err, results) => {
      if (err) {
...
app.delete("/question/:context", (req, res) => {
  ...
  pool.query(
    "DELETE FROM questions_table WHERE Context = ?",
    [context],
    (err, results) => {
      if (err) {
...
app.put("/users/:id", (req, res) => {
  ...
  pool.query(
    "UPDATE users SET name = ?, result = ? WHERE id = ?",
    [name, result, id],
    (err, results) => {
      if (err) {
